        ...
        <Container>
          <Row>
            <Col md={6} className="d-flex flex-column justify-content-center p-5">
              <h1 className="display-4">Hi, I am Huzaifa <span className="wave">👋</span></h1>
              <p className="lead">
